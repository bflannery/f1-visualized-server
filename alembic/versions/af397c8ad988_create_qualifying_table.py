...
def upgrade() -> None:
    op.create_table('qualifying',
                    ...
                    sa.Column('q1_time', sa.Text(), nullable=True),
                    sa.Column('q1_time_ms', sa.Integer(), nullable=True),
                    sa.Column('q2_time', sa.Text(), nullable=True),
                    sa.Column('q2_time_ms', sa.Integer(), nullable=True),
                    sa.Column('q3_time', sa.Text(), nullable=True),
                    sa.Column('q3_time_ms', sa.Integer(), nullable=True),
